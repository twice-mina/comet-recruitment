      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-tpa-dark via-tpa-dark-secondary to-tpa-dark">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
          <div className="text-center max-w-3xl mx-auto">
            ...
            {/* Trust strip */}
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-tpa-hero-text/60 font-body">
      ...
      <section className="py-16 sm:py-20 bg-tpa-cream">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <Link
              href="/jobs"
              className="inline-flex items-center gap-2 px-8 py-3 rounded-xl bg-tpa-gold text-tpa-dark font-semibold font-body hover:bg-tpa-gold-light transition-colors"
            >
              Browse All Jobs
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.step} className="relative bg-white rounded-xl border border-tpa-border p-6 text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <a
                ...
                className="group bg-white rounded-xl border border-tpa-border p-6 hover:border-tpa-gold/40 hover:shadow-md transition-all duration-200"
              >
