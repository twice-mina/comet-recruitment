...
export const mockJobs: Job[] = [
  {
    ...
    requirements: [
      ...
      "TPA Certification or equivalent preferred",
    ],
    salary_min: 150000,
    salary_max: 200000,
    job_type: "hybrid",
  ...
  },
  {
    ...
    requirements: [
      ...
      "Strong publication record in NLP conferences (ACL, EMNLP, etc.) preferred",
  ...
  },
  {
    ...
    requirements: [
      "Currently enrolled in or recently completed a TPA certification program",
...
export function searchJobs(query: string, filters?: { category?: string; job_type?: string }): Job[] {
